...
# NOTE: CTM backbone support has been removed (along with the CTM decoder implementation).
# If you want to reintroduce CTM in the future, consider adding it as an optional dependency
# and placing the implementation under `src/models/ctm/` with clear training scripts.
